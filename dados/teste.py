...
def substituir_virgulas(texto):
    padrao = r'"([^"]*)"'
    resultado = re.sub(padrao, lambda match: match.group(0).replace(',', ';'), texto)
    return resultado

# Exemplo de uso
texto = """
    ',,,,,,
Atari title,Sears title,Code,Designer or programmer,Year,Genre,Notes
32 in 1,-,CX-26163,,1988,"Educational, Sports","A multi-genre cartridge. It is a PAL-only release and is compatible with the Atari 7800.[4] 32 games are included, including games by Atari, Inc., Activision, CommaVid, and U.S. Games."
3-D Tic-Tac-Toe,3-D Tic-Tac-Toe,CX-2618,Carol Shaw,1978,Strategy,
Adventure,Adventure,CX-2613,Warren Robinett,1979,"Adventure, Action-RPG","Contains first well-known Easter egg, containing the designer's name."
...
Atari Video Cube,-,CX-2670,,1983,Strategy,Originally released as mail-order through Atari Club.
...
A Game of Concentration,Memory Match,CX-2642,Jim Huether,1978,Traditional,Re-release of Hunt & Score
Cookie Monster Munch,-,CX-26102,Gary Stark,1983,Educational,Co-developed by Children's Computer Workshop.
Crazy Climber,-,CX-2683,Alex Leavens,1983,Action,Licensed by Nihon Bussan Co. Mail-order exclusive through Atari Club.
...
Phoenix,-,CX-2673,Mike Feinstein and John Mracek,1983,Action,Licensed by Amstar Electronics.
...
Quadrun,-,CX-2686,Steve Woita,1983,Action,Mail-order exclusive through Atari Club.
...
Rubik's Cube,-,CX-2698,,1983,Strategy,Re-release of Atari Video Cube
Secret Quest,-,CX-26170,"Steve DeFrisco (programmer), Nolan Bushnell (designer)",1989,Adventure,Developed by Axlon.
...
Solaris,-,CX-26136,Doug Neubauer,1986,Action,Originally released by mail-order through Atari Club.
...
Swordquest: Waterworld,-,CX-2671,Tod Frye,1983,Adventure,Sold via mail-order through Atari Club.
Taz,-,CX-2699,Steve Woita,1983,Action,
Track & Field,-,CX-26125,Seth Lipkin and Jacques Hugon,1983,Sports,Licensed by Konami.
Vanguard,-,CX-2669,Dave Payne,1983,Action,Licensed by SNK
...
Bachelor Party,Mystique,PlayAround,1982,"Adult, Action","Originally marketed under the ""Swedish Erotica"" series.",
...
Beat Em and Eat Em,Mystique,PlayAround,1982,"Adult, Action","Originally marketed under the ""Swedish Erotica"" series. First pornographic video game released for the Atari 2600.",
...
Bridge,Activision (Larry Kaplan),Activision,1980,Strategy,,
...
Checkers,Activision (Alan Miller),Activision,1980,Strategy,,
...
Commando Raid,James Wickstead Design Associates,U.S. Games,1982,Action,,
...
Creature Strike,,Home Entertainment Suppliers,1992,Shooter,"Released as part of a ""2 PAK SPECIAL""[14]",
...
Custer's Revenge,Mystique,Mystique,1982,"Adult, Western","Originally marketed under the ""Swedish Erotica"" series. Withdrawn in the state of Oklahoma.[15]",
...
Demon Attack,Imagic (Rob Fulop),Imagic,1982,Fixed shooter,,
...
Double Dragon,Imagineering,Activision,1989,Action,licensed by Technōs Japan,
Dragon Treasure,,Zellers,1981,,unlicensed reproduction of Dragonfire[12],
...
Dungeon Master,,Home Entertainment Suppliers,1992,"Action, Adventure","Released as part of a ""2 pak special""[14]",
Earth Dies Screaming,Sirius Software,20th Century Fox,1982,Action,,
Earth Attack,,Zellers,1983,,unlicensed reproduction of Defender[12],
"Eddy Langfinger, der Museumsdieb",,Quelle,1983,Action,PAL release,
Eggomania,James Wickstead Design Associates,U.S. Games,1982,Action,,
...
Entombed,Western Technologies,U.S. Games,1983,"Action, Strategy",Researchers going through the game code in the 2010s have been unable to figure out how the game's maze-generating algorithm managed to consistently generate playable mazes. The original coder says he got it from another programmer who wrote it while drunk.,
...
The Official Frogger (cassette),Starpath,,1983,Action,,
Frogger II: ThreeeDeep!,Parker Brothers,Parker Brothers,1984,Action,,
Front Line,Individeo,Coleco,1984,Action,licensed by Taito,
...
Gopher,James Wickstead Design Associates,U.S. Games,1982,Action,,
...
Jawbreaker,On-Line Systems,Tigervision,1981,Action,,
...
M.A.D.,Western Technologies,U.S. Games,1982,Action,,
...
MegaBoy,,Dynacom,1990,Educational,"The cartridge, the only known 64k Atari 2600 game, came with a Brazilian portable console also called Megaboy.[16]",
...
Missile Control,,Video Gems,1983,Action,PAL-format[17],
Mission 3000 A.D.,Bit Corporation,Bit Corporation,1983,Action,,
Mission Survive,,Video Gems,1983,Action,PAL-format[17],
...
Name This Game,James Wickstead Design Associates,U.S. Games,1982,Action,,
...
Picnic,Western Technologies,U.S. Games,1983,Action,,
Piece o' Cake,Western Technologies,U.S. Games,1983,Action,,
...
Polaris,Tigervision,Tigervision,1982,Action,licensed by Taito,
...
Radar,,Zellers,1983,,unlicensed reproduction of Cruise Missile[12],
...
Red Sea Crossing,Steve Schustack,Inspirational Video Concepts,1983,,Only available through mail order from a magazine. 100 copies were apparently produced but only 2 have been found.[18],
...
The Smurfs Save the Day[19],,Coleco,1983,Action,Kid Vid Voice Module required to function,
Snail Against Squirrel,,Bit Corporation,1983,Action,PAL release. Released in NTSC format as Squirrel,
Sneak 'N Peek,James Wickstead Design Associates,U.S. Games,1982,Simulation,,
...
Space Jockey,James Wickstead Design Associates,U.S. Games,1982,Action,,
...
Squeeze Box,James Wickstead Design Associates,U.S. Games,1982,Action,,
...
Steeplechase,,Video Gems,1983,"Action, Sports",PAL-format[17],
...
Surfer's Paradise: But Danger Below!,,Video Gems,1983,"Action, Sports",PAL-format[17],
Survival Island (cassette),Starpath,Starpath,1983,Adventure,,
Survival Run,Renaissance Technology,Milton Bradley,1983,Action,,
Sword of Saros (cassette),Starpath,Starpath,1983,"Adventure, RPG",,
...
Threshold,On-Line Systems,Tigervision,1983,Fixed shooter,,
...
Towering Inferno,Western Technologies,U.S. Games,1982,Action,,
Treasure Below,,Video Gems,1983,Action,PAL-format[17],
...
Word Zapper,James Wickstead Design Associates,U.S. Games,1982,Action,,
Worm War I,Sirius Software,20th Century Fox,1982,Shooter,,
X-Man,,Universal Gamex,1983,"Adult, Simulation",Adult-themed game unrelated to the X-Men.[20],
...
Zoo Fun,,Suntek,1983,,PAL-only,'
    """
resultado = substituir_virgulas(texto)
print(resultado)
